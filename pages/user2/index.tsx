    ...
    <main className="min-h-screen px-4 py-8 sm:px-6">
      <div className="mx-auto max-w-[1400px]">
        <div className="mb-5 flex items-center justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-amber-300/75">User 2</p>
            <h1 className="mt-2 text-2xl font-semibold text-stone-100">Sortable 8 x 4 Gallery</h1>
          </div>
